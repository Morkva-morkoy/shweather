...
sweather_today = get_forecast("Saint Petersburg, RU", 59.8944, 30.2642, now)
mweather_today = get_forecast("Moscow, RU", 55.7522, 37.6156, now)
dweather_today = get_forecast("Donetsk, UA", 48.023, 37.8022, now)
